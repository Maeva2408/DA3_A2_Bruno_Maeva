...
cbind(as.data.frame(prediction),cbind(cm3,cm4)) %>% as_hux(add_colnames = T)
...
NetEarnings <- rbind(Loss,Win)
cbind(Outcomes,NetEarnings) %>% as_hux()
(Win + Loss) / 420000



OutcomePerInd <- data_holdout[data_holdout$holdout_prediction == "Hyp.Growth",] %>% 
