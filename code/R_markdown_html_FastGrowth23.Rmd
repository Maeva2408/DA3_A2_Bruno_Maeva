...
we defined any firm that have a % CAGR of bigger or equal at 25% in two years as a fast growing firm, it means that they growth for 70% in two years.
...
#logit_models
```
We started by carrying out a probability prediction by logit. 
